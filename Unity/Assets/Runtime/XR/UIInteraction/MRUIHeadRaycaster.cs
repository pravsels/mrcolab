...
namespace Ubiq.XR
{
    ...
    /// </remarks>
    public class MRUIHeadRaycaster : MonoBehaviour
    {
        [System.Serializable]
        ...
        private MRInputController inputController;


        private void Awake()
        {
            raycastResults = new List<RaycastResult>();
            inputController = GetComponentInParent<MRInputController>();
        }
        ...
        void CheckInput()
        {
            ...
            if (inputController.inputDown && eventData.pointerEnter != null)
            {
            ...
            else if(!inputController.inputDown)
            {
